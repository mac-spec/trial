...
import { Activity, BarChart3, Bot, CalendarDays, Download, Eye, Globe2, Languages, MapPin, Maximize2, Play, RefreshCw, Satellite, Search, Send, ShieldCheck, Sparkles, Square, TimerReset } from 'lucide-react';
